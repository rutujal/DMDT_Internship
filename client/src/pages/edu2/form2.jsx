...
export default function Write() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      console.log("hello");
      const res = await axios.post("/form2", newForm2);
      console.log(res);
      postSubmitted = true;
      ...
      {!postSubmitted ?
        ...
        (<div>
          ...
          <form className="writeForm row g-3" onSubmit={handleSubmit} >
            ...
            <div className="col-md-4">
              <label for="inputAddress2" className="form-label">Caste Category</label>
              <input className="input" type="text" name="cc" placeholder="" onChange={e => setCc(e.target.value)} />
            </div>
            <div className="col-md-4">
              <label for="inputAddress2" className="form-label">Certificate Outward no.</label>
              <input className="input" type="number" name="co" placeholder="" onChange={e => setCo(e.target.value)} />
            </div>
            <div className="col-md-4">
              <label for="inputAddress2" className="form-label">Certificate Issue Date</label>
              <input className="input" type="date" name="age" placeholder="" onChange={e => setCi(e.target.value)} />
            </div>
            <div className="col-md-4">
              <label for="inputAddress2" className="form-label">Issuing Authority</label>
              <select className="input" name="Ia" onChange={e => setIa(e.target.value)}>
                <option selected></option>
                <option>Sub-Divisional Officer</option>
                <option>Tahasildar</option>
                <option>Executive Magistrate</option>
                <option>Deputy Collector</option>
              </select>
            </div>
            <div className="col-md-4">
              <label for="inputAddress2" className="form-label">Issuing Authority District</label>
        ...
        <PDF fullName={fullName} s1={s1} />
      }
      <PDF fullName={fullName} s1={s1}  occupation={occupation} village={village} fatherName={fatherName} />
    </>
